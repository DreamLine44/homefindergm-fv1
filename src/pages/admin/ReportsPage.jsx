      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          ...
          <div className="md:hidden divide-y divide-slate-100">
            {filtered.map((r) => {
              const name =
                resolvePersonName(r.reporter) ||
                resolvePersonName(r.reportedBy) ||
                "Anonymous";
                ...
                <div key={r._id} className="px-4 py-3 space-y-2">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <select
                      ...
                      className="text-xs border border-slate-200 rounded-lg px-2 py-1.5 bg-white outline-none focus:border-brand-400"
                    >
                    ...
                    <Link
                      ...
                      className="px-3 py-1.5 text-xs text-brand-600 border border-brand-200 rounded-lg hover:bg-brand-50"
                    >
                      View
                    </Link>
                ...
                {filtered.map((r) => {
                  ...
                  return (
                    <tr key={r._id}>
                      ...
                      <td className="px-5 py-3">{r.targetType || r.type}</td>
                      ...
                      <td className="px-5 py-3">
                        <Link to={`/admin/reports/${r._id}`}>View</Link>
                      </td>
                    </tr>
                  );
                })}
